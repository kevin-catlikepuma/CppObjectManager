...
public:
    ...
    */
    virtual long LoadPlugins(HMODULE instance, const wchar_t* path, 
        const wchar_t* ext = L".plugin", 
        bool recursive = true, bool enableDelayLoading = false) = 0;
    ...
    */
    virtual long LoadPluginFiles(const wchar_t* path, const wchar_t* files, 
        HMODULE instance = NULL, bool enableDelayLoading = false) = 0;
    ...
    */
	...
	virtual bool IsPluginLoaded(const wchar_t* filename) = 0;
};
